...
const messages = [
    ...
    "Это",  
    "Последний",  
    "Ладно, я обманул, хехе, тыкай еще!",  
    "Возможно, ты уже злишься:(",  
    "Хмм",  
    "Ладно тогда",  
    "ТЫК<3",  
    "С 14 ФЕВРАЛЯ!",  
    "С днем святого Валентина ЙОУУ ❤️",  
    "АВХВХАВХААВХВААХХАХАХА",  
    "Нажми на кнопочку снизу 💝"
];
